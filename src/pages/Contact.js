    ...
    return(
        <div className="contact">
            ...
            <div className="card-container">
                <Card imgSrc="https://pngimg.com/uploads/github/github_PNG40.png" reseau="GitHub" name="Nicos-08" imgAlt="Logo GitHub" linkTo="https://github.com/Nicos-08/choixpeau_magique" />
